...
namespace EchangeExporterProto
{
    ...
    class Program
    {
        ...
        private static ExchangeVersion ToExchangeVersionOrDefault(ExchangeServer exchange)
        {
            ...
            return Enum.IsDefined(typeof(ExchangeVersion), exchangeVersionString) ? (ExchangeVersion)Enum.Parse(typeof(ExchangeVersion), exchangeVersionString) : ExchangeVersion.Exchange2010_SP2;
        }
